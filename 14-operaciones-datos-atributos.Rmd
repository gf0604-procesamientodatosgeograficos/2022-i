...
#### Estadísticas policiales de Costa Rica del año 2021
...
```{r carga-datos-estadisticas-policiales, message=FALSE, warning=FALSE}
# Lectura, transformación y visualización de estadísticas policiales
...
###### Covid
Se unen los datos geoespaciales de cantones con los datos de covid-19.

```{r left-join-covid}
# "Join" de los datos geoespaciales de cantones con los de casos positivos de covid. Ambas tablas comparten la columna cod_canton.
...
Se unen los datos geoespaciales de cantones con los datos de estadísticas policiales.
