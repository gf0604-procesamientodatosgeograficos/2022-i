...
```{r md-encabezados, fig.cap='Sintaxis de Markdown: encabezados.', echo=FALSE}
...
```{r md-italica, fig.cap='Sintaxis de Markdown: itálicas.', echo=FALSE}
...
```{r md-negrita, fig.cap='Sintaxis de Markdown: negritas.', echo=FALSE}
...
```{r md-cita, fig.cap='Sintaxis de Markdown: citas textuales.', echo=FALSE}
...
```{r md-enlace, fig.cap='Sintaxis de Markdown: enlaces a otros documentos.', echo=FALSE}
...
```{r md-imagen, fig.cap='Sintaxis de Markdown: imágenes.', echo=FALSE}
...
```{r md-lista-numerada, fig.cap='Sintaxis de Markdown: listas numeradas.', echo=FALSE}
...
```{r md-lista-no-numerada, fig.cap='Sintaxis de Markdown: listas no numeradas.', echo=FALSE}
