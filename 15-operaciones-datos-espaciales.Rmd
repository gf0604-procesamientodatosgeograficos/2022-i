...
Por último, también es posible obtener subconjuntos raster mediante la aplicación en un objeto raster de una "máscara" (*mask*) con la misma extensión y resolución, y que contenga valores lógicos o `NA`. Esta operación puede realizarse con el método `mask()`.
...
altitud <- rast("datos/worldclim/altitud.tif")
