...
```{r cli-ubuntu, fig.cap='Terminal (CLI) del sistema operativo Ubuntu (Linux).', echo=FALSE}
...
```{r gui-ubuntu, fig.cap='Interfaz gráfica GNOME del sistema operativo Ubuntu (Linux).', echo=FALSE}
