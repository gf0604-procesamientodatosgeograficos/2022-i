...
```{r ejemplo-palmerpenguins-01, warning=FALSE}
...
```{r ejemplo-palmerpenguins-02, warning=FALSE}
...
```{r ejemplo-palmerpenguins-03, warning=FALSE, message=FALSE}
...
```{r ejemplo-palmerpenguins-04, warning=FALSE, message=FALSE}
...
```{r ejemplo-palmerpenguins-05, warning=FALSE}
...
```{r ejemplo-palmerpenguins-06, warning=FALSE}
